...
CREATE TABLE IF NOT EXISTS `db_ars`.`ars` (
  ...
  `Ars` VARCHAR(45) NULL DEFAULT NULL,
  `CobMed` VARCHAR(45) NULL DEFAULT NULL,
  `CobClin` VARCHAR(45) NULL DEFAULT NULL,
  `CobCon` VARCHAR(45) NULL DEFAULT NULL,
  PRIMARY KEY (`idArs`))
ENGINE = InnoDB
AUTO_INCREMENT = 5
